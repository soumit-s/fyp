...
const allCategories = [
  { id: 'smartphones', name: 'Smartphones', image: '/phones.jpg', width: 140, height: 120 },
  { id: 'laptops', name: 'Laptops', image: '/laptop.jpg', width: 200, height: 200 },
  { id: 'smartwatches', name: 'Smartwatches', image: '/watches.webp', width: 150, height: 100 },
  { id: 'gamepad', name: 'Gamepad', image: '/pads.webp', width: 200, height: 200 },
  { id: 'cameras', name: 'Cameras', image: '/cameras.jpg', width: 400, height: 600 },
  { id: 'speakers', name: 'Speakers', image: '/speaker.jpg', width: 200, height: 350 },
];
    ...
    <div className="font-sans">
      ...
      <div className="p-6">
        ...
        <input
          ...
          className="mt-4 w-full border border-gray-300 rounded-xl p-3"
          value={searchTerm}
      ...
      {/* Top Categories */}
      <div className="px-6">
        <h2 className="text-lg font-semibold mb-4">Browse our top categories</h2>
      ...
      {/* Promo Banner */}
      <div className="mt-8 mx-6 bg-black text-white rounded-xl flex flex-col md:flex-row items-center justify-between p-6 md:p-8 min-h-[180px] md:min-h-[220px] gap-4 overflow-hidden">
        <div className="flex-1">
          <h2 className="text-4xl md:text-6xl font-extrabold leading-tight">LIMITLESS</h2>
          <p className="text-xl md:text-3xl mt-1">Endless Options, One Rent!</p>
          <p className="mt-2 text-sm md:text-base text-gray-300">Starting from ₹999/month</p>
      ...
      <div className="px-6 py-12 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="flex gap-4 items-start bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
            >
              <Image
                src={benefit.icon}
                alt={benefit.title}
